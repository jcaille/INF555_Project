...
public class ExactDijkstra {
	...
	//NB: il faudrait partir du même point que pour les géodésiques, mais si on suit arêtes, il faudrait partir d'un noeud
	//Sinon, je ne sais pas trop comment tu veux afficher les résultats du Dijkstra
